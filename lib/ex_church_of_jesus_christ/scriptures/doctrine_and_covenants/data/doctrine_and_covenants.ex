...
defmodule ExChurchOfJesusChrist.Scriptures.DoctrineAndCovenants.Data.DoctrineAndCovenants do
  @moduledoc false
  ...
  def metadata do
    %{
      ...
      subtitle: "Containing Revelations Given to Joseph Smith, the Prophet with Some Additions by His Successors in the Presidency of the Church",
      introduction: [],
      aliases: [
        "dc",
        "d and c",
