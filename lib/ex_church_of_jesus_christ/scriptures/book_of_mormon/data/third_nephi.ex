...
defmodule ExChurchOfJesusChrist.Scriptures.BookOfMormon.Data.ThirdNephi do
  @moduledoc false
  ...
  def metadata do
    %{
      ...
      url_slug: "3-ne",
      title: "Third Nephi",
      subtitle: "The Book of Nephi, the Son of Nephi, Who Was the Son of Helaman",
      introduction: [
  ...
  def headings, do: %{
    11 => "Jesus Christ did show himself unto the people of Nephi, as the multitude were gathered together in the land Bountiful, and did minister unto them; and on this wise did he show himself unto them."
  }
end
